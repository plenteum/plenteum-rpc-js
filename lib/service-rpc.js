...
var WalletServiceRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof WalletServiceRPC)) return new WalletServiceRPC(opts)
  ...
  this.defaultFee = (opts.defaultFee !== undefined) ? opts.defaultFee : 0
...
WalletServiceRPC.prototype.reset = function (opts) {
...
WalletServiceRPC.prototype.save = function () {
  return new Promise((resolve, reject) => {
...
WalletServiceRPC.prototype.getViewKey = function () {
  return new Promise((resolve, reject) => {
...
WalletServiceRPC.prototype.getSpendKeys = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.getMnemonicSeed = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
WalletServiceRPC.prototype.getStatus = function () {
  return new Promise((resolve, reject) => {
...
WalletServiceRPC.prototype.getAddresses = function () {
  return new Promise((resolve, reject) => {
...
WalletServiceRPC.prototype.createAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.deleteAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
WalletServiceRPC.prototype.getBalance = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
WalletServiceRPC.prototype.getBlockHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.getTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
    opts.blockHash = opts.blockHash || false
...
WalletServiceRPC.prototype.getUnconfirmedTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
...
WalletServiceRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.newTransfer = function (address, amount) {
  return {
    address: address,
...
WalletServiceRPC.prototype.sendTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    var that = this
    opts = opts || {}
    opts.addresses = opts.addresses = []
...
WalletServiceRPC.prototype.createDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses = []
    opts.transfers = opts.transfers || false
...
WalletServiceRPC.prototype.getDelayedTransactionHashes = function () {
  return new Promise((resolve, reject) => {
...
WalletServiceRPC.prototype.deleteDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.sendDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.transactionHash = opts.transactionHash || false
...
WalletServiceRPC.prototype.sendFusionTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.estimateFusion = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.threshold = opts.threshold || this.defaultFusionThreshold
    opts.addresses = opts.addresses || []
...
WalletServiceRPC.prototype.createIntegratedAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
WalletServiceRPC.prototype.getFeeInfo = function () {
  return this.getNodeFeeInfo()
}

WalletServiceRPC.prototype.getNodeFeeInfo = function () {
  return new Promise((resolve, reject) => {
...
WalletServiceRPC.prototype._postToWalletd = function (method, params) {
  return new Promise((resolve, reject) => {
...
module.exports = WalletServiceRPC
