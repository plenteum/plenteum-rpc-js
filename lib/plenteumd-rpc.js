...
var PlenteumdRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof PlenteumdRPC)) return new PlenteumdRPC(opts)
  this.host = opts.host || '127.0.0.1'
  this.port = opts.port || 44016
  this.timeout = opts.timeout || 2000
  this.ssl = opts.ssl || false
}

PlenteumdRPC.prototype.getBlocks = function (opts) {
...
PlenteumdRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
PlenteumdRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
PlenteumdRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
PlenteumdRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
PlenteumdRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.getHeight = function () {
  return this.height()
}

PlenteumdRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.getInfo = function () {
  return this.info()
}

PlenteumdRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.feeInfo = function () {
  return this.fee()
}

PlenteumdRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getPeers = function () {
  return this.peers()
}

PlenteumdRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getBlocks = function (opts) { // getblocks
...
PlenteumdRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
PlenteumdRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
PlenteumdRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
PlenteumdRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
PlenteumdRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
PlenteumdRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
PlenteumdRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
PlenteumdRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
